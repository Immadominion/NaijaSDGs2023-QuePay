    ...
    return Scaffold(
      ...
      child: Container(
          ...
          child:
                ...
                child: Row(
                    ...
                    children: [
                      CustomImageView(
                          ...
                          height: 20.v,
                          width: 32.h,
                          margin: EdgeInsets.only(top: 3.v, bottom: 121.v),
                          onTap: () {
                          ...
                          child: Stack(
                              ...
                              children: [
                                Align(
                                    ...
                                    child: Text("msg_transfer_to_social".tr,
            ...
            Text("lbl_amount".tr, style: CustomTextStyles.bodyLargeBlack90001),
            SizedBox(height: 2.v),
            Container(
                width: 382.h,
            ...
            Text("lbl_remark".tr, style: CustomTextStyles.bodyLargeBlack90001),
            SizedBox(height: 2.v),
